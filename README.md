...
### نموذج الكتب:
الحقول **الإلزامية فقط**: اسم الكتاب، المؤلف، رقم الخزانة، رقم الرف. باقي الأعمدة اختيارية.
ترتيب الأعمدة (للاستيراد): اسم الكتاب، المؤلف، التصنيف، المحقق، الأجزاء، دار النشر، السنة، النسخ، الحالة، الخزانة، الرف، ملاحظات.
